...
**6 WebSockets + 1 HTTP endpoint + 2 HTTP proxy chains** connecting browser and container processes.
...
## Spec modules
  ...
  - **Domain** -- shared primitives: `Url`, `SessionUuid`, `PreviewPort`, `AgentChatPort`, `ProxyPort`, `Bytes`
  ...
  - **HttpProxy** -- port derivation, proxy chains, readiness probing
