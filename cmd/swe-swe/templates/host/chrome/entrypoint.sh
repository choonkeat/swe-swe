...
# This script installs enterprise certificates into:
# 1. System CA store (for curl, wget, and other tools)
# 2. NSS database (for Chromium browser - it doesn't use system CA store)
#
# Required for:
